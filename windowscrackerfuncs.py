...
kmslist=["hq1.chinancce.com", "
" ,"54.223.212.31" ,"kms.cnlic.com" ,"kms.chinancce.com" ,"kms.ddns.net", "franklv.ddns.net", "k.zpale.com", "m.zpale.com" ,"mvg.zpale.com" ,"kms.shuax.com kensol263.imwork.net:1688", "xykz.f3322.org", "kms789.com" ,"dimanyakms.sytes.net:1688" ,"kms.03k.org:1688"]
...
def determine_if_system_can_be_hacked(x):
   for stuff in supportedsystemlist:
    if x==stuff:
        return True
